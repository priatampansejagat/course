...
<head>
	...
	<!-- set the description -->
	<meta name="description" content="International Research Collaboration">
	<!-- set the Keyword -->
	...
	<link rel="stylesheet" href="<?= base_url(); ?>assets/visitor/css/bootstrap.css">
	<!-- include the site stylesheet -->
	<link rel="stylesheet" href="<?= base_url(); ?>assets/visitor/css/plugins.css">
	<!-- include the site stylesheet -->
	<link rel="stylesheet" href="<?= base_url(); ?>assets/visitor/css/colors.css">
	<!-- include the site stylesheet -->
	<link rel="stylesheet" href="<?= base_url(); ?>assets/visitor/style.css">
	<!-- include the site responsive stylesheet -->
	<link rel="stylesheet" href="<?= base_url(); ?>assets/visitor/css/responsive.css">
</head>
		...
		<main id="main">
			...
			<section class="intro-block">
				<div class="slider fade-slider">
					<div>
						<!-- intro block slide -->
						<article class="intro-block-slide overlay bg-cover" style="background-image: url(<?= base_url(); ?>assets/visitor/images/background-1.jpg);">
							<div class="align-wrap container">
								<div class="align">
									<div class="anim">
										<h1 class="intro-block-heading">The 2nd International Conference on Religious and Cultural Science & Call for Papers</h1>
									</div>
									<div class="anim delay1">
										<p>Can Social, Economic, and Business Science Relate to World Peace?</p>
									</div>
									<div class="anim delay2">
										<div class="btns-wrap">
											<a href="<?= base_url('register') ?>" class="btn btn-warning btn-theme text-uppercase">Join Now</a>
										</div>
									</div>
								</div>
							</div>
				...
				<div class="container">
					...
					<aside class="features-aside">
						...
						<a href="#" class="col">
							...
							<div class="description">
								<h2 class="features-aside-heading">OJS</h2>
							</div>
						</a>
						<a href="#" class="col">
							<span class="icn-wrap text-center no-shrink">
							...
							<div class="description">
								<h2 class="features-aside-heading">Video Conference</h2>
							</div>
						</a>
					</aside>
				</div>
			...
			<section class="popular-posts-block container">
				...
				<div class="row">
					<div class="col-lg-6">
						<img src="<?= base_url(); ?>assets/visitor/images/poster1.png" width="100%" alt="computer">
					</div>
					<div class="col-lg-6">
						<img src="<?= base_url(); ?>assets/visitor/images/poster2.jpg" width="100%" alt="computer">
					</div>
				</div>
				<hr>
				<p>
			...
			<aside class="subscription-aside-block bg-theme text-white">
				...
				<form action="#" class="container newsletter-sub-form">
					<div class="row form-holder">
						<div class="col-xs-12 col-sm-6 col">
							<div class="text-wrap">
								...
								<div class="inner-wrap">
									<label for="email">Come and Join Now</label>
						...
						<div class="col-xs-12 col-sm-6 col">
							<div class="btns-wrap">
								<a href="<?= base_url('register') ?>" class="btn btn-dark text-uppercase text-uppercase">Join Now</a>
							</div>
						</div>
					</div>
				</form>
			...
			<!-- <aside class="aside container">
				<div class="row">
					<div class="col-xs-12 col-sm-6 col-md-3 col">
						...
						<p>Peneleh Research Institute Indonesia and SMS Varanasi India are cooperating to conduct a research collaboration with the aims to map youths perceptions and how they see racism, religious conflicts and peace.</p>
						<a href="<?= base_url('register') ?>" class="btn btn-default text-uppercase">Start Joining Now</a>
					</div>
				...
				<div class="container">
					<div class="row holder">
						...
						<div class="col-xs-12 col-sm-pull-6 col-sm-6">
							<p><a href="#">Peneleh Research Institute</a> | &copy; 2020 <a href="#">Indonesia</a>, All rights reserved</p>
						</div>
					</div>
				</div>
			</footer>
